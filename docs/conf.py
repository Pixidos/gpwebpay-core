...
html_title = "GPWebPay-Core %s Manual" % get_version()
...
htmlhelp_basename = 'GPWebPay-Coredoc'
...
latex_documents = [
    (master_doc, 'GPWebPay-Core.tex', u'GPWebPay-Core Documentation',
...
man_pages = [
    (master_doc, 'gpwebpay-core', u'GPWebPay-Core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GPWebPay-Core', u'GPWebPay-Core Documentation',
     author, 'GPWebPay-Core', 'One line description of project.',
     'Miscellaneous'),
]
